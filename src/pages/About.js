import { Container, Stack, Flex, Box, Text, Image, Heading, HStack } from "@chakra-ui/react";
...
export default function About() {
  return (
    <><Box bg='primary.200' >
        ...
        >
          ...
          <Stack flex={1}
            ...
            <MotionHeading
              ...
              bgGradient="linear(to-r, brown, primary.600, orange.400)"
              bgClip="text"
      ...
      <Container maxW={{ base: 'xl', md: '2xl', lg: '4xl' }} my={10}>
        <Stack direction={{ base: 'column', md: 'column', lg: 'row' }} justify={'space-between'}>
          <HStack direction={{ base: 'column', md: 'column', lg: 'row' }} my='2' mr='5' w='full'>
            <Stack w='full'>
              {/*  Skills */}
              <Box>
